...
public class Trip implements Comparable<Trip> {
    ...
    public boolean accord(Trip2 trip) {
        if (trip.getDepartureCity().equals(departureCity) && trip.getDestinationCity().equals(destinationCity) && trip.getTransportType().equals(transportType) && trip.getDatePri().equals(date) && trip.getPrice() <= maxPrice) return true;
        return false;
    }
}
